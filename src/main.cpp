...
ez::Drive chassis(
    ...
    {-4, -1, 2, -3, -4},     // Left Chassis Ports (negative port will reverse it!)
    {8, 5, -6, 7, 8},  // Right Chassis Ports (negative port will reverse it!)
...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      {"Slow Score of Long Goal and Match Loads, Then Hook In", laz_long_descore_slow_match},
      {"Quick Score of Long Goal, Then Hook In", laz_long_descore_quick_match},
      {"Mid then Long Goal", laz_mid_long_match_auton},
      {"Long Then Middle Goal", laz_long_mid_match_auton},
